...
from .views import article_list_view, article_detail_view, article_create_view, article_edit_view, article_delete_view
...
urlpatterns = [
    ...
    path("<slug:article_slug>/delete/", article_delete_view, name="article_delete"),
