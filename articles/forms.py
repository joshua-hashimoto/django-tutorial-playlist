...
class ArticleForm(forms.ModelForm):
    ...
    description = forms.CharField(max_length=250, label="概要", widget=forms.Textarea(attrs={"class": "form-control", "rows": 3}))
    ...
    class Meta:
        ...
        widgets = {
            ...
            "publish_at": forms.TextInput(attrs={"id": "calendar", "class": "form-control", "placeholder": "設定していない場合、その記事は公開されません。"}),
        }
